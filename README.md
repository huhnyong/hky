...
.tableheadandbody{border-spacing: 10px 10px; align:center; margin-left: auto; margin-right: auto; width:50%; height:95%; cellpadding:20px; cellspacing:10;}
...
.listwidth{text-align : center;height:7.5%;width:10%;padding-left: 5px; padding-right: 5px; margin:10px; border:1px solid tomato; border-radius: 10px/10px;}
